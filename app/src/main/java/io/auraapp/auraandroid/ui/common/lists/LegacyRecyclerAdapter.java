...
public abstract class LegacyRecyclerAdapter extends RecyclerView.Adapter<LegacyItemViewHolder> {
    ...
    private static final String TAG = "@aura/" + LegacyRecyclerAdapter.class.getSimpleName();
...
//            mListView.smoothScrollToPosition(mItems.indexOf(item));
    ...
    public LegacyRecyclerAdapter(@NonNull Context context, RecyclerView listView) {
        super();
        if (listView == null) {
